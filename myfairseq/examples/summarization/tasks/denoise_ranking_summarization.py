...
@register_task('denoise_ranking_summaization')
class DenoiseRankSummarizationTask(TranslationFromPretrainedBARTTask):
    """
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        noisy_ds = SentenceReplaceDataset(summ_ds, leads, self.src_dict, self.args.seed, self.args.replace_ratio)
        rank_ds = ContrastiveDataset(noisy_ds, self.src_dict, self.args.seed, self.args.negative_sample_number)
